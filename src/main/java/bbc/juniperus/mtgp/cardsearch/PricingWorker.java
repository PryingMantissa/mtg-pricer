...
public class PricingWorker{
	...
	private Map<SearchListener,CardFinder> listeners = new HashMap<SearchListener,CardFinder>();
	...
	/**
	 * See {@link SearchListener#startedSearchingFor(Card, CardFinder)}
	...
	/**
	 * See {@link SearchListener#finishedSearchingFor(CardResult, CardFinder)}
	...
	/**
	 * Informs all {@link SearchListener} that the search with a given card finder
	...
	/**
	 * Informs all registered {@link SearchListener}s that the search with a given card finder
